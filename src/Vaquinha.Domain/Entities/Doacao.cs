...
namespace Vaquinha.Domain.Entities
{
    public class Doacao : Entity
    {
                      ...
                      Pessoa dadosPessoais, CartaoCredito formaPagamento, Endereco enderecoCobranca, bool AceitaTaxa = false)
        {
            ...
            Valor = aceitaTaxa ? valor * 1.2 : valor;   //coloco minha regra de negócio: se aceitaTaxa for true, o doador paga os 20%
        ...
        public bool AceitaTaxa { get; private set; }    //uso no TDD
